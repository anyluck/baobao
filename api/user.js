...
/*export function spreadCommission(data){
  return request.post('spread/commission',data);
}
 ...
 * 加盟
 * */
export function jointg(data) {
  return request.post("user/jointg", data);
}
export function tgsetting() {
  // console.log("tgsetting",request.post("user/tgsetting", []))
  return request.post("user/tgsetting",[]);
}
/*
 * 签到用户信息
 * */
...
export function setLevel(data) {
  return request.post("userlevel/setlevel", data);
}